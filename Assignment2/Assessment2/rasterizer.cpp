...
// {   
//     Vector3f edges[3];
//     edges[0] << _v[0].x() - _v[1].x(), _v[0].y() - _v[1].y(), 0;
//     edges[1] << _v[1].x() - _v[2].x(), _v[1].y() - _v[2].y(), 0;
//     edges[2] << _v[2].x() - _v[0].x(), _v[2].y() - _v[0].y(), 0;

//     Vector3f point;
//     point << x + 0.5, y + 0.5, 0 ;
//     // std::cout << (edges[0].cross(point - _v[0]).z() > 0) << std::endl;
//     bool direction = edges[0].cross(point - _v[0]).z() > 0;
//     if ((direction != (edges[1].cross(point - _v[1]).z() > 0)) || (direction == (edges[2].cross(point - _v[2]).z() > 0)))
//         return false;
//     return true;
...
void rst::rasterizer::draw(pos_buf_id pos_buffer, ind_buf_id ind_buffer, col_buf_id col_buffer, Primitive type)
{
    ...
    for (auto& i : ind)
    {
        ...
        // transform from [-1, 1]^2 to [0, width] x [0, height]
...
void rst::rasterizer::rasterize_triangle(const Triangle& t) {
    ...
    // auto v = t.toVector4();
    // int minx = v[0].x(), miny = v[0].y(), maxx = v[0].x(), maxy = v[0].y();
    // for (int i = 1; i < 3; i ++) {
    //     if (v[i].x() < minx) {
    //         minx = v[i].x();
    //     } 
